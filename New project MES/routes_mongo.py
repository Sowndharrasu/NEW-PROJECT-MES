...
from models_mongo import UserDoc, EmployeeDoc, MachineDoc
from flask_paginate import Pagination
from models_mongo import CustomerDoc
...
def customers_list():
    ...
    items = []
    customers = Pagination(page=page, total=len(items), per_page=10, record_name='customers')
...
@login_required
def work_orders_new():
    return render_template('work_orders_new.html')
